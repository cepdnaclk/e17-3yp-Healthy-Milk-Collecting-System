...
class VerifyForForgotPasswordScreen extends StatefulWidget {


  @override
  _VerifyForForgotPasswordScreenState createState() => _VerifyForForgotPasswordScreenState();
}

class _VerifyForForgotPasswordScreenState extends State<VerifyForForgotPasswordScreen> {
...
var res = await EmailAuth(sessionName: "Password reset").sendOtp(recipientMail: email);
...
var res = await EmailAuth(sessionName: "Password reset").
...
if(res){
  ...
  Navigator.push(context, MaterialPageRoute(builder: (context) => ForgotPasswordResetScreen()));
  ...
  child: SingleChildScrollView(
    child: Column(
      ...
      mainAxisAlignment: MainAxisAlignment.center,
             children: [
               SizedBox(height:170),
                   Text("Verify it's you",style: TextStyle(fontSize: 30,color:black,fontWeight: FontWeight.bold)),
                    SizedBox(height:20),
                 Padding(
                   ...
                   Padding(
                     ...
                     child: GestureDetector(
                       ...
                       style: TextStyle(fontSize: 20,color:Colors.black.withOpacity(.5),fontWeight: FontWeight.w400))),
                   ),
