...
import 'package:milkapp/test/device.dart';
...
class _SelectBondedDevicePage extends State<SelectBondedDevicePage> {
 ...
 late bool isHC05Found = false;
 late BluetoothDevice hc05;
        ...
        .map(
          ...
          (_device) => BluetoothDeviceListEntry(
            ...
            onTap: () {
              ...
              widget.onCahtPage(_device.device); //call on chat function
            },
          ),
        )
        .toList();
