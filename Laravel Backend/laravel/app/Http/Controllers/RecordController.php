...
public function addSubRecord(Request $request){
    $sub_data = [
        'ph_value'=>$request->input('ph_value'),
        'density'=>$request->input('ph_value'),
        'volume'=>$request->input('ph_value'),
        'fat_rate'=>$request->input('ph_value'),
        'temperature'=>$request->input('ph_value'),
        'grade'=>$request->input('ph_value'),
        'price_rate'=>$request->input('ph_value'),
