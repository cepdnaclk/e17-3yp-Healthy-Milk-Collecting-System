...
class ConnectController extends Controller
{
    ...
    public function incomingReqsFromFarmers(Request $req){
        try{
        $collector_id = $req->input('collector_id');
    ...
    public function connectedFarmersWithCollector(Request $req){
        try{
        $collector_id = $req->input('collector_id');
    ...
    public function connectedCollectorsWithFarmer(Request $req){
        try{
        $farmer_id = $req->input('farmer_id');
